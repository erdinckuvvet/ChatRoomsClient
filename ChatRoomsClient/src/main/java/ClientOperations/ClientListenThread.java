            ...
            try {
                ...
                switch (msg.type) {
                    ...
                    case DOWNLOAD_FILE_REQUEST:
                        ...
                        String filePath = FileOperations.createFile(this.client.userName+downloadedFileMessage.fileName);
                        if (FileOperations.writeContent(filePath, downloadedFileMessage.content)) {
